...
template <typename K, typename E, typename H>
Map<K, E, H>::Map(size_t minNSlots, bool fixed) :
    m_size(0),
...
Map<K, E, H>::Map(InputIt first, InputIt last, bool fixed) :
    m_size(0),
...
template <typename K, typename E, typename H>
Map<K, E, H>::Map(std::initializer_list<V> pairs, bool fixed) :
    m_size(0),
...
void Map<K, E, H>::rehash(size_t minNSlots) {
    ...
    Map<K, E, H> map(minNSlots, m_fixed);
    m_rehashing = true;
...
template <typename K, typename E, typename H>
bool Map<K, E, H>::fixed() const {
    return m_fixed;
}

template <typename K, typename E, typename H>
void Map<K, E, H>::fixed(bool fixed) {
    m_fixed = fixed;
}
