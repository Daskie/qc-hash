...
namespace std {
    ...
    template <typename K, typename V, typename H, typename KE, typename A> void swap(qc_hash_alt::Map<K, V, H, KE, A> & a, qc_hash_alt::Map<K, V, H, KE, A> & b) noexcept;
...
namespace std {
    ...
    template <typename K, typename V, typename H, typename KE, typename A>
    inline void swap(qc_hash_alt::Map<K, V, H, KE, A> & a, qc_hash_alt::Map<K, V, H, KE, A> & b) noexcept {
        a.swap(b);
    }
